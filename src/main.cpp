...
GLfloat position[] = {2.0,-1.0, -0.5, 1.0};
GLfloat mat_diffuse[] = {0.6, 0.6, 0.6, 1.0};
GLfloat mat_specular[] = {1.0, 1.0, 1.0, 1.0};
GLfloat mat_shininess[] = {50.0};

GLfloat ambientOne[] = {0.05, 0.05, 0.05, 1.0};
GLfloat positionOne[] = {3.0,0.0,0.0,1.0};
GLfloat specularOne[] = {1.0,1.0,1.0,1.0};
GLfloat diffuseOne[] = {0.6, 0.6, 0.6, 1.0};
...
void initLights(void)
{
    ...
    glLightfv(GL_LIGHT1, GL_AMBIENT, ambientOne);
    glLightfv(GL_LIGHT1, GL_POSITION, positionOne);
    glLightfv(GL_LIGHT1, GL_SPECULAR, specularOne);
    glLightfv(GL_LIGHT1, GL_DIFFUSE, diffuseOne);
...
void setCamera( void )
{
//    gluLookAt(5,20,40,0,10,0,0,1,0);
...
static void setupShaders()
{
    ...
    if (shaderNum == 1)
        ...
        shaderProg = new GLSLProgram(checkerBoardVS, checkerBoardFS);  
    else if (shaderNum == 5)
        shaderProg = new GLSLProgram(extraVS, extraFS);     
